      ...
      sections={[
        {
          ...
          paragraphs: [
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-2 mb-2 uppercase tracking-tight">Comprendre avant de réorienter</span>,
            <span>Une réorientation réussie commence par une <strong className="font-semibold text-brand-darkblue">analyse approfondie du parcours initial</strong>. Nous prenons le temps d’étudier le cursus suivi, les résultats obtenus, les compétences développées, les expériences vécues et les difficultés rencontrées.</span>,
            <span>Au-delà de ce premier diagnostic académique, nous réalisons également un travail approfondi sur <strong className="font-semibold text-brand-darkblue">qui est réellement l’étudiant</strong> : ses aspirations, ses centres d’intérêt, ses forces, ses axes de progression et sa personnalité.</span>,
            <span>Cette approche globale nous permet de dépasser la simple notion d’insatisfaction pour construire un <strong className="font-semibold text-brand-darkblue">repositionnement stratégique du projet d’orientation</strong>, aligné à la fois avec le potentiel réel de l’étudiant et ses ambitions personnelles.</span>,
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Repositionner le projet avec méthode</span>,
            <span>À partir de cette analyse complète, nous accompagnons l’étudiant dans la construction d’un <strong className="font-semibold text-brand-darkblue">nouveau projet académique</strong>. Nous clarifions les objectifs, explorons les filières alternatives et sélectionnons des établissements adaptés au profil et aux ambitions.</span>,
          ],
        ...
        },
        {
          ...
          paragraphs: [
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-2 mb-2 uppercase tracking-tight">Aligner le niveau académique avec le nouveau cap</span>,
            <>
            ...
            <span>Cette étape permet de <strong className="font-semibold text-brand-darkblue">sécuriser la transition</strong> et d’aborder la nouvelle orientation avec un <strong className="font-semibold text-brand-darkblue">socle académique solide</strong>.</span>,
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Reconstruire des candidatures convaincantes</span>,
            <span>La réorientation nécessite souvent d’expliquer son parcours avec clarté et maturité. Nous accompagnons les étudiants dans la <strong className="font-semibold text-brand-darkblue">constitution des dossiers</strong>, la rédaction de <strong className="font-semibold text-brand-darkblue">lettres de motivation cohérentes</strong> et la structuration d’un discours valorisant le chemin parcouru.</span>,
            <span>Une attention particulière est portée à la <strong className="font-semibold text-brand-darkblue">narration du projet</strong> : il s’agit de transformer une bifurcation en preuve de réflexion, d’évolution et de détermination.</span>,
            <span>Les étudiants sont également préparés aux <strong className="font-semibold text-brand-darkblue">entretiens</strong> à travers des simulations et un travail approfondi sur la posture, la confiance et la cohérence du discours.</span>,
          ],
        },
        {
          title: "Une expertise globale au service d’un accompagnement humain",
          paragraphs: [
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-2 mb-2 uppercase tracking-tight">Une expertise nationale et internationale</span>,
            ...
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Un accompagnement humain et rassurant</span>,
            <span>La réorientation est souvent une période sensible, marquée par des interrogations personnelles et parfois une <strong className="font-semibold text-brand-darkblue">perte de confiance</strong>.</span>,
            <span>Chez STUDASSIST, nous accordons une place centrale à <strong className="font-semibold text-brand-darkblue">l’écoute, la pédagogie et l’accompagnement humain</strong>, afin de transformer cette transition en expérience constructive et structurante.</span>,
            <span>Nous travaillons en lien direct avec l’étudiant — et, lorsque cela est pertinent, avec sa famille — afin d’assurer un <strong className="font-semibold text-brand-darkblue">cadre transparent et sécurisant</strong> tout au long du processus.</span>,
          ],
        },
        {
          title: "À qui s’adresse la réorientation ?",
          paragraphs: [
            <span>Notre accompagnement s’adresse aux <strong className="font-semibold text-brand-darkblue">lycéens souhaitant changer de filière</strong>, aux <strong className="font-semibold text-brand-darkblue">étudiants post-bac</strong> remettant en question leur premier choix, ainsi qu’aux <strong className="font-semibold text-brand-darkblue">titulaires de Bac+3</strong> désireux de repositionner leur trajectoire académique. Plus largement, il concerne toute personne souhaitant redonner du sens à son parcours et construire une orientation plus alignée avec son potentiel.</span>,
          ],
        },
      ]}

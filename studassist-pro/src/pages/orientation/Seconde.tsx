      ...
      sections={[
        {
          ...
          paragraphs: [
            <strong className="block text-brand-darkblue font-semibold text-sm mb-1 uppercase tracking-tight">Une approche progressive et évolutive</strong>,
            <span>En Seconde, l’objectif n’est pas de figer un <strong className="font-semibold text-brand-darkblue">projet définitif</strong>.</span>,
            <span>Nous construisons avec l’élève un <strong className="font-semibold text-brand-darkblue">pré-projet d’orientation</strong>, qui sert de boussole pour orienter les choix de spécialités, structurer le travail scolaire, développer certaines compétences clés, et anticiper les exigences futures.</span>,
            <span>Ce projet reste volontairement <strong className="font-semibold text-brand-darkblue">ouvert et adaptable</strong>, afin de s’ajuster à la maturation, aux résultats et aux aspirations évolutives de l’élève.</span>,
            <strong className="block text-brand-darkblue font-semibold text-sm mt-4 mb-1 uppercase tracking-tight">Un diagnostic approfondi et un profiling global</strong>,
            <span>L’accompagnement débute par un <strong className="font-semibold text-brand-darkblue">entretien familial initial</strong>, permettant d’aligner attentes parentales et aspirations de l’élève.</span>,
            <span>Nous réalisons ensuite des <strong className="font-semibold text-brand-darkblue">entretiens individuels de profiling</strong> afin d’analyser le parcours scolaire, les matières de prédilection, les centres d’intérêt, la personnalité, ainsi que les capacités d’analyse et d’engagement de l’élève.</span>,
            <span>Ce travail permet de construire une <strong className="font-semibold text-brand-darkblue">lecture globale du profil</strong>, indispensable pour guider les premiers choix structurants des <strong className="font-semibold text-brand-darkblue">trois spécialités de première</strong>.</span>,
            <strong className="block text-brand-darkblue font-semibold text-sm mt-4 mb-1 uppercase tracking-tight">Un choix stratégique des trois spécialités</strong>,
        ...
        },
        {
          ...
          paragraphs: [
            <strong className="block text-brand-darkblue font-semibold text-sm mb-1 uppercase tracking-tight">Poser un plan d’action et des objectifs structurés</strong>,
            ...
            <strong className="block text-brand-darkblue font-semibold text-sm mt-4 mb-1 uppercase tracking-tight">Garder une ouverture sur l’international</strong>,
            <span>
        ...
        },
        {
          ...
          paragraphs: [
            <strong className="block text-brand-darkblue font-semibold text-sm mb-1 uppercase tracking-tight">Nous nous positionnons comme un intermédiaire entre l’élève et ses parents</strong>,
            <span>Le choix des spécialités peut être source d’interrogations et parfois de divergences. STUDASSIST agit comme un <strong className="font-semibold text-brand-darkblue">tiers de confiance</strong>, facilitant un dialogue serein et structuré entre l’élève et ses parents. Nous apportons une analyse objective et argumentée pour permettre une <strong className="font-semibold text-brand-darkblue">décision partagée et éclairée</strong>.</span>,
            <span>Les réformes du lycée et la diversité des parcours rendent les choix plus complexes. Nous accompagnons également les parents en leur apportant une compréhension claire des <strong className="font-semibold text-brand-darkblue">implications des spécialités</strong>, une vision long terme des parcours possibles, et un cadre structuré pour accompagner leur enfant sans pression excessive.</span>,
            <strong className="block text-brand-darkblue font-semibold text-sm mt-4 mb-1 uppercase tracking-tight">Une communication en continu, centralisée et transparente</strong>,
            <span>Tout au long du parcours, nous restons en contact avec l’élève et sa famille. Les échanges et documents sont centralisés dans un <strong className="font-semibold text-brand-darkblue">espace dédié</strong>, garantissant <strong className="font-semibold text-brand-darkblue">transparence et continuité</strong>.</span>,
          ],
        },
        {
          title: "À qui s’adresse l’orientation en Seconde ?",
          paragraphs: [
            <strong className="block text-brand-darkblue font-semibold text-sm mb-1 uppercase tracking-tight">Aux élèves de Seconde qui :</strong>,
            <ul className="list-disc pl-5 space-y-1 my-2 text-gray-500 text-sm">

      ...
      sections={[
        {
          ...
          paragraphs: [
            <span>Notre soutien scolaire au lycée repose sur une <strong className="font-semibold text-brand-darkblue">approche globale et stratégique</strong>, bien au-delà d'un simple renforcement académique.</span>,
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Un diagnostic académique et méthodologique précis</span>,
            <span>Chaque élève bénéficie d'une <strong className="font-semibold text-brand-darkblue">évaluation approfondie</strong> de son niveau, de ses méthodes de travail, de ses <strong className="font-semibold text-brand-darkblue">matières de spécialité</strong>, de ses <strong className="font-semibold text-brand-darkblue">matières du tronc commun</strong> et de ses objectifs d'orientation, <strong className="font-semibold text-brand-darkblue">en tenant compte du système scolaire suivi</strong> (français, marocain, bilingue ou international).</span>,
            <span>Ce diagnostic permet de définir un <strong className="font-semibold text-brand-darkblue">plan d'accompagnement ciblé</strong>, aligné à la fois avec les exigences du programme et les ambitions post-bac.</span>,
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Un accompagnement académique exigeant</span>,
            <span>Nous accompagnons les lycéens aussi bien dans leurs <strong className="font-semibold text-brand-darkblue">matières de spécialité</strong> que dans les <strong className="font-semibold text-brand-darkblue">matières du tronc commun</strong>, qui restent déterminantes pour la <strong className="font-semibold text-brand-darkblue">moyenne générale</strong>, la <strong className="font-semibold text-brand-darkblue">cohérence du dossier scolaire</strong> et la <strong className="font-semibold text-brand-darkblue">réussite aux épreuves du bac</strong>.</span>,
            <span>Notre accompagnement s'adapte au parcours et au système scolaire de chaque élève, avec pour objectifs :</span>,
            <span>• <strong className="font-semibold text-brand-darkblue">Optimiser les résultats</strong> dans l'ensemble des matières (tronc commun et spécialités)</span>,
            <span>• Renforcer la <strong className="font-semibold text-brand-darkblue">compréhension en profondeur des notions clés</strong></span>,
            <span>• Développer des <strong className="font-semibold text-brand-darkblue">méthodes de travail efficaces pour préparer l'entrée aux études supérieures</strong></span>,
            <span>• Sécuriser un <strong className="font-semibold text-brand-darkblue">dossier académique solide et cohérent</strong>, en lien avec les projets d'orientation post-bac et les ambitions de l'élève</span>,
            <span>Chez STUDASSIST, la performance se construit autant dans l'excellence disciplinaire que dans la <strong className="font-semibold text-brand-darkblue">maîtrise rigoureuse des fondamentaux</strong>.</span>,
          ],
        },
        {
          title: "Notre méthodologie différenciée nous permet un suivi rigoureux orienté résultats et orientation",
          paragraphs: [
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-2 mb-2 uppercase tracking-tight">Une méthodologie de soutien scolaire différenciée</span>,
            <span>Chez <strong className="font-semibold text-brand-darkblue">STUDASSIST</strong>, le soutien scolaire au lycée repose sur une <strong className="font-semibold text-brand-darkblue">pédagogie différenciée</strong>, déployée en <strong className="font-semibold text-brand-darkblue">petits groupes de 2 à 4 élèves maximum</strong>, avec des <strong className="font-semibold text-brand-darkblue">niveaux hétérogènes maîtrisés</strong>.</span>,
            <span>Cette méthodologie permet :</span>,
            <span>• De développer l'<strong className="font-semibold text-brand-darkblue">autonomie intellectuelle</strong> de l'élève</span>,
            <span>• De stimuler l'<strong className="font-semibold text-brand-darkblue">émulation académique</strong> et l'apprentissage par observation</span>,
            <span>• D'encourager une <strong className="font-semibold text-brand-darkblue">dynamique de travail structurante</strong></span>,
            <span>• Tout en garantissant un <strong className="font-semibold text-brand-darkblue">suivi individualisé</strong>, adapté à l'avancement réel de chaque élève</span>,
            <span>Nos enseignants ajustent leurs approches pédagogiques, leurs contenus et leurs exigences <strong className="font-semibold text-brand-darkblue">en fonction du système scolaire suivi</strong>, tout en maintenant des <strong className="font-semibold text-brand-darkblue">standards académiques élevés</strong>, indispensables à la réussite au lycée.</span>,
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Un suivi rigoureux orienté résultats et orientation</span>,
            <span>Le soutien scolaire STUDASSIST s'appuie sur un <strong className="font-semibold text-brand-darkblue">suivi continu et structuré</strong> :</span>,
            ...
            <span>Ce pilotage permet d'inscrire le travail scolaire dans une <strong className="font-semibold text-brand-darkblue">logique de progression durable</strong>, cohérente avec les projets d'études supérieures.</span>,
          ],
        },
        {
          title: "Un accompagnement qui va au-delà du soutien scolaire et qui s'inscrit sur le long terme",
          paragraphs: [
            <span>Au lycée, le soutien scolaire ne peut être envisagé isolément. Les enjeux académiques s'articulent progressivement avec la <strong className="font-semibold text-brand-darkblue">préparation aux examens</strong>, l'<strong className="font-semibold text-brand-darkblue">accès aux filières sélectives</strong> et la <strong className="font-semibold text-brand-darkblue">constitution d'un dossier post-bac solide</strong>, au Maroc, en France et à l'international.</span>,
            <span>Chez <strong className="font-semibold text-brand-darkblue">STUDASSIST</strong>, le soutien scolaire s'inscrit naturellement dans une <strong className="font-semibold text-brand-darkblue">logique de continuité</strong> avec nos autres pôles d'expertise.</span>,
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Préparation au baccalauréat</span>,
            <>
            ...
            <span>Le soutien scolaire permet de consolider les bases, tandis que les <strong className="font-semibold text-brand-darkblue">Prépas Bac</strong> ciblent la <strong className="font-semibold text-brand-darkblue">maîtrise des attendus, la méthodologie d'examen et la performance le jour J des épreuves du baccalauréat</strong>.</span>,
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Préparations aux concours et filières sélectives</span>,
            <>
              Pour les lycéens visant des <strong className="font-semibold text-brand-darkblue">parcours d'excellence</strong>, le soutien scolaire peut être articulé avec une <strong className="font-semibold text-brand-darkblue">préparation spécifique aux concours</strong>, notamment pour les{" "}
            ...
            <span>Le travail académique est alors orienté vers la <strong className="font-semibold text-brand-darkblue">sélectivité, la stratégie de concours et les exigences propres à chaque épreuve</strong>.</span>,
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Certifications de langues</span>,
            <span>Dans de nombreux parcours post-bac, les <strong className="font-semibold text-brand-darkblue">certifications de langues</strong> constituent un critère déterminant d'admission.</span>,
            <>
            ...
            <span>Le soutien scolaire assure la régularité et la progression linguistique, tandis que les <strong className="font-extrabold text-brand-darkblue">préparations aux certifications</strong> visent l'<strong className="font-semibold text-brand-darkblue">obtention des scores requis</strong>.</span>,
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Une logique de parcours maîtrisé</span>,
            <>
              Chez <strong className="font-semibold text-brand-darkblue">STUDASSIST</strong>, chaque accompagnement est pensé comme un <strong className="font-semibold text-brand-darkblue">parcours évolutif et cohérent</strong>. Le soutien scolaire au lycée constitue souvent la <strong className="font-semibold text-brand-darkblue">première étape structurante</strong>, avant d'orienter l'élève vers des préparations plus spécifiques, en fonction de son projet académique et de ses ambitions, et de l'accompagner à concrétiser son projet d'{" "}
        ...
        },
        {
          ...
          paragraphs: [
            ...
            <span>• Rencontrant des <strong className="font-semibold text-brand-darkblue">difficultés ciblées</strong> dans certaines matières</span>,
            <span>• Souhaitant <strong className="font-semibold text-brand-darkblue">améliorer significativement leurs résultats</strong></span>,
            <span>• Ayant besoin de <strong className="font-semibold text-brand-darkblue">méthodes de travail plus efficaces</strong></span>,
            <span>• Préparant des <strong className="font-semibold text-brand-darkblue">filières sélectives ou internationales</strong></span>,
            <span>• <strong className="font-semibold text-brand-darkblue">Disposant déjà d'un bon niveau académique et souhaitant viser l'excellence</strong></span>,
            <span>• Scolarisés dans des <strong className="font-semibold text-brand-darkblue">systèmes français, marocains, bilingues ou internationaux</strong></span>,
            <span>• Recherchant un <strong className="font-semibold text-brand-darkblue">accompagnement holistique qui soit exigeant, structuré et orienté résultats</strong></span>,
          ],
        },
      ]}

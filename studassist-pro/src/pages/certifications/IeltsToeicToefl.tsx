      ...
      sections={[
        {
          ...
          paragraphs: [
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-2 mb-2 uppercase tracking-tight">IELTS, TOEFL ou encore TOEIC : faire le bon choix</span>,
            <span>Le choix du test dépend directement du <strong className="font-semibold text-brand-darkblue">projet de l'élève</strong>. L'<strong className="font-semibold text-brand-darkblue">IELTS</strong> est aujourd'hui le plus demandé par les universités internationales, tandis que le <strong className="font-semibold text-brand-darkblue">TOEFL</strong> est particulièrement répandu pour les candidatures aux États-Unis. Le <strong className="font-semibold text-brand-darkblue">TOEIC</strong>, quant à lui, s'inscrit davantage dans un cadre professionnel. Chez <strong className="font-semibold text-brand-darkblue">STUDASSIST</strong>, nous guidons les élèves dans ce choix afin de garantir la cohérence entre leur certification et leurs objectifs académiques.</span>,
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Un enjeu déterminant pour les candidatures</span>,
            <span>Le <strong className="font-semibold text-brand-darkblue">score obtenu</strong> constitue un véritable levier dans un dossier. Il permet non seulement de valider un niveau linguistique, mais aussi de renforcer la crédibilité de la candidature et d'accéder à des formations plus sélectives. Dans certains cas, il peut également conditionner l'obtention de <strong className="font-semibold text-brand-darkblue">bourses</strong>.</span>,
            <span>Chaque établissement fixe ses propres exigences :</span>,
            <ul className="space-y-2 mt-2 ml-1">
              <li className="flex gap-2.5 items-start"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-brand-teal shrink-0" /><span>score IELTS de <strong className="font-semibold text-brand-darkblue">6.0 à 6.5</strong> ou TOEFL de <strong className="font-semibold text-brand-darkblue">80 à 90</strong> pour de nombreuses formations universitaires ;</span></li>
              <li className="flex gap-2.5 items-start"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-brand-teal shrink-0" /><span>IELTS de <strong className="font-semibold text-brand-darkblue">7.0 à 7.5</strong> ou TOEFL supérieur à <strong className="font-semibold text-brand-darkblue">100</strong> pour les programmes plus sélectifs ;</span></li>
            ...
            <span>Chez <strong className="font-semibold text-brand-darkblue">STUDASSIST</strong>, nous aidons chaque élève à définir un <strong className="font-semibold text-brand-darkblue">objectif de score cohérent</strong> avec son projet d'études, les établissements visés et son niveau initial, afin de construire une stratégie réaliste et adaptée.</span>,
          ],
        },
        {
          ...
          paragraphs: [
            ...
            <span>Chez <strong className="font-semibold text-brand-darkblue">STUDASSIST</strong>, chaque élève débute par un <strong className="font-semibold text-brand-darkblue">test de niveau</strong>, permettant d'évaluer précisément ses compétences et de définir un plan de travail adapté. La préparation peut se faire :</span>,
            <ul className="space-y-2 mt-2 ml-1">
              <li className="flex gap-2.5 items-start"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-brand-teal shrink-0" /><span>en <strong className="font-semibold text-brand-darkblue">petits groupes de 8 élèves maximum</strong>, favorisant l'échange et la progression ;</span></li>
              <li className="flex gap-2.5 items-start"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-brand-teal shrink-0" /><span>en <strong className="font-semibold text-brand-darkblue">format individuel</strong>, pour les élèves nécessitant un accompagnement spécifique ou souhaitant accélérer leur progression.</span></li>
            </ul>,
            <span>Nous proposons également :</span>,
            <ul className="space-y-2 mt-2 ml-1">
              <li className="flex gap-2.5 items-start"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-brand-teal shrink-0" /><span>des <strong className="font-semibold text-brand-darkblue">séances hebdomadaires</strong>, pour une progression régulière ;</span></li>
            ...
            <span>Notre approche repose sur une <strong className="font-semibold text-brand-darkblue">parfaite maîtrise des formats d'épreuves</strong> et des attentes des correcteurs. Chaque section du test fait l'objet d'un travail spécifique, avec des stratégies adaptées, des entraînements ciblés et des mises en situation en <strong className="font-semibold text-brand-darkblue">conditions réelles</strong>. L'objectif est clair : <strong className="font-semibold text-brand-darkblue">optimiser le score en maximisant la performance</strong> dans chaque partie de l'examen.</span>,
          ],
        },
        {
          title: "L'approche STUDASSIST dans la préparation des certifications d'anglais",
          paragraphs: [
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-2 mb-2 uppercase tracking-tight">Développer des compétences académiques solides</span>,
            <span>Au-delà des techniques d'examen, nous accompagnons les élèves dans le développement de <strong className="font-semibold text-brand-darkblue">compétences durables</strong> :</span>,
            <ul className="space-y-2 mt-2 ml-1">
              ...
              <li className="flex gap-2.5 items-start"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-brand-teal shrink-0" /><span>enrichissement du <strong className="font-semibold text-brand-darkblue">vocabulaire académique</strong>.</span></li>
            </ul>,
            <span>Chaque élève bénéficie de <strong className="font-semibold text-brand-darkblue">retours personnalisés</strong>, lui permettant d'identifier ses axes d'amélioration et de progresser efficacement.</span>,
            ...
            <span>Chez <strong className="font-semibold text-brand-darkblue">STUDASSIST</strong>, la préparation à l'IELTS ou au TOEFL s'inscrit dans une <strong className="font-semibold text-brand-darkblue">démarche globale</strong>. Elle est directement liée au <Link to="/orientation/terminale" className="text-brand-darkblue font-black underline underline-offset-2">projet d'orientation</Link> de l'élève, aux destinations envisagées et aux établissements ciblés. Cette approche permet de définir des objectifs de score pertinents et cohérents avec les ambitions académiques de l'élève.</span>,
          ],
        },
        {
          title: "Un accompagnement en continu avec des professeurs expérimentés",
          paragraphs: [
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-2 mb-2 uppercase tracking-tight">Un encadrement par des professeurs experts des certifications internationales</span>,
            <span>Les élèves sont accompagnés par des <strong className="font-semibold text-brand-darkblue">enseignants spécialisés</strong> dans la préparation des certifications d'anglais internationales. Leur parfaite maîtrise des formats IELTS et TOEFL leur permet d'identifier rapidement les axes de progression de chaque candidat et de mettre en place des <strong className="font-semibold text-brand-darkblue">stratégies adaptées aux objectifs visés</strong>.</span>,
            <span>Au-delà du travail linguistique, ils accompagnent les élèves dans l'acquisition des <strong className="font-semibold text-brand-darkblue">méthodes, réflexes et techniques</strong> indispensables pour performer dans chacune des épreuves et atteindre le <strong className="font-semibold text-brand-darkblue">score cible</strong>.</span>,
            ...
            <span>La préparation ne s'arrête pas aux séances. Nous restons en contact avec nos élèves, leur proposons des <strong className="font-semibold text-brand-darkblue">ressources complémentaires</strong> et les accompagnons jusqu'au <strong className="font-semibold text-brand-darkblue">passage du test</strong>, afin de sécuriser leur progression.</span>,
          ],
        },
        {

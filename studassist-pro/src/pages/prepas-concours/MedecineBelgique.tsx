      ...
      sections={[
        {
          ...
          paragraphs: [
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-2 mb-2 uppercase tracking-tight">Un examen exigeant et structurant</span>,
            <span>L'examen d'entrée en médecine en Belgique évalue à la fois :</span>,
            <ul className="space-y-2 mt-2 ml-1">
              <li className="flex gap-2.5 items-start"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-brand-teal shrink-0" /><span>les <strong className="font-semibold text-brand-darkblue">connaissances scientifiques</strong> : biologie, chimie, physique… ;</span></li>
              <li className="flex gap-2.5 items-start"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-brand-teal shrink-0" /><span>les <strong className="font-semibold text-brand-darkblue">capacités de raisonnement</strong> ;</span></li>
            ...
            <span>Il ne s'agit pas uniquement d'un test académique, mais d'une <strong className="font-semibold text-brand-darkblue">évaluation globale du profil</strong> du candidat.</span>,
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Le processus d'admission en Belgique</span>,
            <span>L'accès aux études de médecine en Belgique repose sur un <strong className="font-semibold text-brand-darkblue">processus spécifique</strong>, différent des systèmes français ou marocain. Pour les étudiants non-résidents, l'admission est soumise à plusieurs étapes :</span>,
            <ul className="space-y-2 mt-2 ml-1">
              ...
              <li className="flex gap-2.5 items-start"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-brand-teal shrink-0" /><span>participation à un <strong className="font-semibold text-brand-darkblue">tirage au sort</strong> (quota non-résidents défini à chaque année universitaire) ;</span></li>
              <li className="flex gap-2.5 items-start"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-brand-teal shrink-0" /><span>réussite d'un <strong className="font-semibold text-brand-darkblue">examen d'entrée obligatoire</strong> qui constitue l'étape clé du processus.</span></li>
            </ul>,
            ...
            <span>Les étudiants admis présentent généralement un <strong className="font-semibold text-brand-darkblue">profil académique solide et régulier</strong>. La réussite à cet examen repose sur :</span>,
            <ul className="space-y-2 mt-2 ml-1">
              ...
              <li className="flex gap-2.5 items-start"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-brand-teal shrink-0" /><span>une capacité de <strong className="font-semibold text-brand-darkblue">raisonnement et d'analyse</strong> ;</span></li>
              ...
              <li className="flex gap-2.5 items-start"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-brand-teal shrink-0" /><span>une <strong className="font-semibold text-brand-darkblue">forte motivation</strong> pour les études médicales.</span></li>
            </ul>,
            <span>Au-delà des résultats scolaires, la capacité à <strong className="font-semibold text-brand-darkblue">travailler efficacement sous pression</strong> et à structurer ses réponses est déterminante.</span>,
            ...
            <span>L'accès aux études de médecine en Belgique représente une <strong className="font-semibold text-brand-darkblue">opportunité stratégique</strong> pour de nombreux élèves. La sélectivité du processus impose une préparation rigoureuse et anticipée. Cette démarche peut être complétée par un <Link to="/orientation/terminale" className="text-brand-darkblue font-black underline underline-offset-2">accompagnement en orientation scolaire</Link>.</span>,
        ...
        },
        {
          ...
          paragraphs: [
            ...
            <span>La préparation à la médecine en Belgique doit être <strong className="font-semibold text-brand-darkblue">anticipée</strong>. Idéalement dès la classe de <strong className="font-semibold text-brand-darkblue">Première</strong>, pour consolider les bases scientifiques, puis en <strong className="font-semibold text-brand-darkblue">Terminale</strong>, pour intensifier les entraînements et se préparer sereinement à l'examen. Commencer tôt permet d'acquérir les bons automatismes et d'aborder l'examen avec confiance.</span>,
            ...
            <span>Chez <strong className="font-semibold text-brand-darkblue">STUDASSIST</strong>, nous proposons une préparation qui s'inscrit dans la durée, à travers :</span>,
            <ul className="space-y-2 mt-2 ml-1">
              <li className="flex gap-2.5 items-start"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-brand-teal shrink-0" /><span>des <strong className="font-semibold text-brand-darkblue">séances hebdomadaires régulières</strong>, pour consolider progressivement les bases scientifiques ;</span></li>
            ...
            <span>Cette double approche permet d'allier <strong className="font-semibold text-brand-darkblue">continuité, rigueur et montée en puissance</strong> à l'approche des épreuves.</span>,
            ...
            <span>Cette méthode permet de développer <strong className="font-semibold text-brand-darkblue">rigueur, rapidité et efficacité</strong>.</span>,
          ],
        },
        {
          ...
          paragraphs: [
            ...
            <span>Les élèves sont accompagnés par des enseignants <strong className="font-semibold text-brand-darkblue">spécialisés en matières scientifiques</strong>, maîtrisant parfaitement les exigences de l'examen d'entrée en médecine en Belgique.</span>,
          ],
        },
        {
          ...
          paragraphs: [
            ...
            <span>La réussite à l'examen d'entrée repose autant sur les <strong className="font-semibold text-brand-darkblue">connaissances</strong> que sur la capacité à <strong className="font-semibold text-brand-darkblue">performer</strong>. Nous accompagnons les élèves dans le développement de leur :</span>,
            <ul className="space-y-2 mt-2 ml-1">
            ...
            <span>L'objectif est de <strong className="font-semibold text-brand-darkblue">maximiser les performances</strong> le jour de l'épreuve.</span>,

      ...
      sections={[
        {
          ...
          paragraphs: [
            ...
            <span>Les résultats obtenus à ces concours jouent un <strong className="font-semibold text-brand-darkblue">rôle déterminant</strong> dans l'accès aux écoles d'ingénieurs. Ils s'inscrivent dans une <strong className="font-semibold text-brand-darkblue">évaluation globale du dossier</strong>, incluant les notes de contrôle continu, les appréciations scolaires, mais aussi les activités & centres d'intérêts et les lettres de motivation dans le cadre du <Link to="/orientation/terminale" className="text-brand-darkblue font-black underline underline-offset-2">projet d'orientation scolaire</Link>. Une préparation efficace permet de <strong className="font-semibold text-brand-darkblue">sécuriser son admission</strong> et de viser les écoles les plus sélectives.</span>,
            ...
            <span>Cette approche permet de renforcer la maîtrise des notions tout en développant <strong className="font-semibold text-brand-darkblue">rapidité et efficacité</strong>. Elle présente également un avantage stratégique : les exercices d'approfondissement scientifique travaillés dans le cadre de la préparation aux concours contribuent directement à la réussite aux <Link to="/prepa-bac-specialites" className="text-brand-darkblue font-black underline underline-offset-2">épreuves de spécialité du Baccalauréat</Link>, notamment en mathématiques et en physique-chimie. Les élèves consolident ainsi leur niveau académique tout en se préparant efficacement aux concours.</span>,
          ],
        },
        {
          ...
          paragraphs: [
            ...
            <span>Au-delà des connaissances, la réussite à ces concours repose sur la capacité à performer dans un environnement exigeant. Nous accompagnons les élèves dans le développement d'un <strong className="font-semibold text-brand-darkblue">esprit concours</strong>, en travaillant sur la <strong className="font-semibold text-brand-darkblue">gestion du temps</strong>, la <strong className="font-semibold text-brand-darkblue">gestion du stress</strong>, les stratégies de réponse et la capacité à prioriser les exercices. L'objectif est de <strong className="font-semibold text-brand-darkblue">maximiser le score</strong> et de faire la différence face aux autres candidats.</span>,
            ...
            <span>Les sessions en petits groupes permettent de créer une <strong className="font-semibold text-brand-darkblue">dynamique collective de travail</strong>, favorisant l'entraide, le challenge et la progression. Les élèves évoluent dans un environnement stimulant, propice à la performance.</span>,
          ],
        },
        {
          ...
          paragraphs: [
            ...
            <span>Les élèves sont accompagnés par des enseignants <strong className="font-semibold text-brand-darkblue">spécialisés en mathématiques et en sciences</strong>, maîtrisant parfaitement les exigences des concours d'ingénieurs. Leur accompagnement permet d'apporter <strong className="font-semibold text-brand-darkblue">rigueur, méthode et efficacité</strong>.</span>,
          ],
        },
        {
          title: "À qui s'adresse la préparation des concours d'écoles d'ingénieurs post-bac en France ?",
          paragraphs: [
            <span>Cette préparation s'adresse aux élèves de <strong className="font-semibold text-brand-darkblue">Terminale</strong> souhaitant intégrer les principales écoles d'ingénieurs post-bac en France via les concours <strong className="font-semibold text-brand-darkblue">Avenir, Geipi Polytech, Puissance Alpha ou Advance</strong>.</span>,

...
const QuiSommesNous = () => {
  ...
  const steps = [
    { title: "Diagnostic Approfondi", desc: "Analyse complète du profil, des méthodes de travail et des aspirations de l'élève.", icon3d: "https://img.icons8.com/?size=100&id=M9qgDCA7L9As&format=png&color=68A487" },
    { title: "Parcours sur Mesure", desc: "Construction d'un plan d'accompagnement stratégique avec des objectifs clairs et mesurables.", icon3d: "https://img.icons8.com/?size=100&id=sGNEMWKG3WcQ&format=png&color=2F52A4" },
    { title: "Accompagnement Académique", desc: "Soutien scolaire ciblé dans les matières clés pour renforcer les acquis, optimiser les dossiers académiques, préparer les certifications de langues et consolider les compétences nécessaires à la réussite.", icon3d: "https://img.icons8.com/?size=100&id=IJ7yETPMYNTy&format=png&color=DB5C69" },
    { title: "Suivi Continu", desc: "Pilotage constant des progrès et ajustements stratégiques pour optimiser le parcours.", icon3d: "https://img.icons8.com/?size=100&id=CKlCW599p0wL&format=png&color=DF7959" },
    { title: "Orientation vers l'Avenir", desc: "Aide à la définition du projet professionnel, à l'élaboration du plan d'études, à la construction des candidatures et à la préparation rigoureuse des concours et entretiens les plus exigeants.", icon3d: "https://img.icons8.com/?size=100&id=SCQVeCkY6ZWr&format=png&color=E8AD52" },
  ];

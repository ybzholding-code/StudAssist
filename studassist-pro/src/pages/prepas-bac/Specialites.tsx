      ...
      sections={[
        {
          ...
          paragraphs: [
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-2 mb-2 uppercase tracking-tight">Comprendre le fonctionnement des épreuves de spécialités</span>,
            ...
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">L'importance du contrôle continu</span>,
            <span>Au-delà des épreuves finales, le <strong className="font-semibold text-brand-darkblue">contrôle continu</strong> représente une part significative de la note du Baccalauréat.</span>,
            ...
            <span>Cela implique une exigence de régularité et de progression. Chez <strong className="font-semibold text-brand-darkblue">STUDASSIST</strong>, nous accompagnons les élèves dans cette dynamique, afin de maintenir un niveau constant tout au long de l'année.</span>,
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Un levier déterminant pour l'orientation post-bac</span>,
            ...
            <span>Une performance solide dans les spécialités constitue ainsi un <strong className="font-semibold text-brand-darkblue">avantage décisif</strong> pour accéder aux filières sélectives, au Maroc comme à l'international.</span>,
          ],
        },
        {
          title: "L'approche STUDASSIST dans la préparation des épreuves de spécialités",
          paragraphs: [
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-2 mb-2 uppercase tracking-tight">Une préparation sur mesure, adaptée à chaque spécialité</span>,
            <span>Chez <strong className="font-semibold text-brand-darkblue">STUDASSIST</strong>, nous adaptons notre accompagnement aux exigences spécifiques de chaque discipline.</span>,
            ...
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Une méthodologie rigoureuse et progressive</span>,
            ...
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Une préparation alignée avec le projet d'orientation</span>,
            <span>Chez <strong className="font-semibold text-brand-darkblue">STUDASSIST</strong>, la préparation aux spécialités s'inscrit dans une logique globale.</span>,
        ...
        },
        {
          ...
          paragraphs: [
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-2 mb-2 uppercase tracking-tight">Un format adapté à chaque profil</span>,
            <span>Les séances sont proposées en <strong className="font-semibold text-brand-darkblue">petits groupes de 2 à 4 élèves maximum</strong>, favorisant un suivi individualisé et une progression rapide.</span>,
            ...
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Une préparation également adaptée au Bac STMG</span>,
            <span>Chez <strong className="font-semibold text-brand-darkblue">STUDASSIST</strong>, nous accompagnons également les élèves préparant un <strong className="font-semibold text-brand-darkblue">Baccalauréat STMG</strong>, dont les épreuves répondent à des exigences spécifiques.</span>,
            ...
            <span>Les élèves sont accompagnés par des <strong className="font-semibold text-brand-darkblue">professeurs spécialisés par matière</strong>, disposant d'une parfaite maîtrise des programmes et des exigences du Baccalauréat.</span>,

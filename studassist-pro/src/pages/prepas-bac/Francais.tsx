      ...
      sections={[
        {
          ...
          paragraphs: [
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-2 mb-2 uppercase tracking-tight">Comprendre les exigences du Bac de Français</span>,
            <span>Le Bac de Français repose sur deux épreuves complémentaires :</span>,
            <span>• Une <strong className="font-semibold text-brand-darkblue">épreuve écrite</strong>, où l'élève choisit entre commentaire de texte, dissertation ou, selon la filière, contraction de texte et essai</span>,
            <span>• Une <strong className="font-semibold text-brand-darkblue">épreuve orale</strong>, composée d'une explication de texte suivie d'un entretien autour d'une œuvre étudiée</span>,
            ...
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Un programme exigeant et structurant</span>,
            <span>Le programme officiel du Bac de Français s'articule autour de <strong className="font-semibold text-brand-darkblue">quatre grands objets d'étude</strong> :</span>,
        ...
        },
        {
          ...
          paragraphs: [
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-2 mb-2 uppercase tracking-tight">Maîtriser les fondamentaux pour réussir</span>,
            ...
            <span>• La compréhension des <strong className="font-semibold text-brand-darkblue">logiques de raisonnement et d'argumentation</strong></span>,
            <span>• La maîtrise des <strong className="font-semibold text-brand-darkblue">mouvements littéraires et des figures de style</strong></span>,
            <span>• L'assimilation des <strong className="font-semibold text-brand-darkblue">objets d'étude au programme</strong> (roman, théâtre, poésie, littérature d'idées)</span>,
            <span>• L'acquisition de <strong className="font-semibold text-brand-darkblue">références culturelles solides</strong> à travers l'étude des œuvres au programme</span>,
            <span>Ce travail de fond permet de donner de la profondeur aux analyses et de valoriser les copies.</span>,
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Une préparation complète : écrit et oral</span>,
            <span>Notre accompagnement couvre l'ensemble des épreuves du Bac de Français.</span>,
            <span>À l'écrit, les élèves apprennent à structurer une <strong className="font-semibold text-brand-darkblue">dissertation</strong>, construire un <strong className="font-semibold text-brand-darkblue">commentaire</strong> précis et développer une argumentation claire. Un travail approfondi est mené sur la méthodologie, la construction des plans et la qualité de l'expression. Pour les élèves de la filière <strong className="font-semibold text-brand-darkblue">STMG</strong>, la préparation est spécifiquement adaptée aux exigences de l'épreuve, avec un travail approfondi sur la <strong className="font-semibold text-brand-darkblue">contraction de texte et l'essai (épreuve de synthèse)</strong>, ainsi que sur la capacité à restituer et structurer efficacement les idées.</span>,
        ...
        },
        {
          ...
          paragraphs: [
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-2 mb-2 uppercase tracking-tight">Une méthodologie progressive et orientée résultats</span>,
            ...
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Un encadrement par des enseignants experts</span>,
            <span>Les élèves sont accompagnés par nos <strong className="font-semibold text-brand-darkblue">professeurs expérimentés</strong>, spécialisés dans l'enseignement du français et les exigences du Baccalauréat.</span>,
            <span>Certains d'entre eux ont été <strong className="font-semibold text-brand-darkblue">correcteurs d'épreuves</strong>, ce qui leur permet de transmettre une compréhension précise des attentes du jury et des critères d'évaluation.</span>,
            <span className="block font-semibold text-brand-darkblue text-[15px] mt-6 mb-2 uppercase tracking-tight">Une préparation adaptée à chaque profil</span>,
